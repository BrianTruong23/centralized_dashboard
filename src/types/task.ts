...
export interface Task {
  ...
  scheduled_on?: string; // ISO date string (YYYY-MM-DD)
  scheduled_start?: string; // ISO timestamp for planned start
  scheduled_end?: string; // ISO timestamp for planned end
