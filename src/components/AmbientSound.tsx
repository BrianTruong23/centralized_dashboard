...
export function AmbientSound() {
  ...
  return (
    <div className="hidden md:block fixed bottom-4 right-4 z-[300]">
      {isExpanded ? (
            ...
            {(Object.keys(SOUNDS) as SoundType[]).map((type) => (
              <button
                ...
                className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-all ${
                  activeSound === type
                    ? 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-900 dark:border-gray-100 shadow-sm'
